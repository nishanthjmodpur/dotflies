...
-- local wallpaper = "~/Pictures/mountains-snow.jpg"
...
-- hl.window_rule({
    ...
    -- hl.window_rule({
        ...
        hl.config({
            ...
            ---- KEYBINDINGS ----
            ---------------------
            -- bind = SUPER, S, exec, grim -g "$(slurp)" ~/Pictures/snip.png
            ...
            hl.bind(mainMod .. " + D", hl.dsp.exec_cmd("$HOME/dotflies/rofi/.config/rofi/launchers/type-6/launcher.sh"))
            ...
            hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("pkill waybar && sleep 0.2 && waybar"))
